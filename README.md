...
![Discord CDN](https://cdn.discordapp.com/attachments/1393678846431203348/1395167405273256077/New_Project.png?ex=68797666&is=687824e6&hm=9832d61d7b269e0ffc9960019af30776b9441b5df203d1b196813dc792cacedd&)

Polar Backend is a universal Fortnite private server backend written in [JavaScript](https://en.wikipedia.org/wiki/JavaScript)
...
- `/createhostaccount` - Creates a host account for Polar Backend.
...
1) Go to **Config/config.json** in the directory you extracted Polar Backend into.
...
## How to start Polar Backend
1) Install [NodeJS](https://nodejs.org/en/) and [MongoDB](https://www.mongodb.com/try/download/community).
2) **Download** and **Extract** Polar Backend to a safe location.
3) Run **"install_packages.bat"** to install all the required modules.
4) Go to **Config/config.json** in the directory you extracted Polar Backend into.
...
## Credits
Credits have been moved to the **Contributors** section of github. If I forgot to include someone, write to **evil** on Discord

---

**Polar Backend** is under continuous development and there could be errors of any kind, if you want to give advice on what to add and how to improve the project or report any errors you can do so by writing to **us** on Discord
